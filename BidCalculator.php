...
if (!$result)
		...
		die("Error: Data not found..");
				...
				$result6 = mysql_query("SELECT job_info.Parts_ID FROM job_info, job where job.Cust_Job_ID = '$fid' AND job.Job_ID = job_info.Job_ID");

						

$test9 = mysql_fetch_array($result6);
...
if (!$result6)
...

	{
		 ...
		 mysql_query("INSERT INTO `parts_list` (Parts_ID, Part_Num, Quantity, CalQuanPrice) 

		 VALUES ('$PartsID', '$parts1_Save','$quantity1field_Save','$total1field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts2_Save' ,'$quantity2field_Save','$total2field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts3_Save' ,'$quantity3field_Save','$total3field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts4_Save' ,'$quantity4field_Save','$total4field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts5_Save' ,'$quantity5field_Save','$total5field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts6_Save' ,'$quantity6field_Save','$total6field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts7_Save' ,'$quantity7field_Save','$total7field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts8_Save' ,'$quantity8field_Save','$total8field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts9_Save' ,'$quantity9field_Save','$total9field_Save')")
		 ...
		 VALUES ('$PartsID', '$parts10_Save' ,'$quantity10field_Save','$total10field_Save')")
		 ...
		 or die(mysql_error());
				...
				/* mysql_query("UPDATE contract_info, job set PTot_Price = ($grandtotal_Save + PTot_Price) WHERE job.Cust_Job_ID = $testingpartsid AND job.Contract_ID = contract_info.Contract_ID")
...
<select class = "event_selection" name="name1" required id="parts1">
      <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                         
                </option>
            <?php } ?>
</select> 
...
<br>
 ...
 <label>Material</label>
<select class = "event_selection" name="name2" required id="parts2">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                     
...
<label>Price</label>
 ...
 <label>Material</label>
<select class = "event_selection" name="name3" required id="parts3">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                     
...
<label>Price</label>
 ...
 <label>Material</label>
<select class = "event_selection" name="name4" required id="parts4">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                      
...
<label>Price</label>
 ...
 <label>Material</label>
<select class = "event_selection" name="name5" required id="parts5">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                      
...
<br>
 ...
 <label>Material</label>
<select class = "event_selection" name="name6" required id="parts6">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                   <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                      
...
<label>Material</label>
<select class = "event_selection" name="name7" required id="parts7">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                      
...
<label>Material</label>
<select class = "event_selection" name="name8" required id="parts8">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                     
...
<label>Material</label>
<select class = "event_selection" name="name9" required id="parts9">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                     
...
<label>Material</label>
<select class = "event_selection" name="name10" required id="parts10">
        <option value="None"></option>
            <?php foreach($list as $row) { ?>
                    <option value="<?php echo $row['Part_Num']; ?>">
                    <?php echo $row['Part_Num']; ?> | <?php echo $row['Part_Desc']; ?> | <?php echo $row['Part_Cost']; ?> | <?php echo $row['Part_Price']; ?>                  
